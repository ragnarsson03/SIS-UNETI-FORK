...
export default function DashboardLayout() {
  ...
  return (
    <div className="flex h-screen bg-surface text-on-surface overflow-hidden">
      ...
      {/* ══════════════════════════════════════════════
          SIDEBAR — Idéntico al prototipo CODIGO.HTML
      ══════════════════════════════════════════════ */}
      <aside className="h-screen w-64 shrink-0 fixed left-0 top-0 z-40 bg-white border-r border-outline flex flex-col py-6 px-4">
      ...
      <div className="flex flex-col flex-1 ml-64 overflow-hidden">
        ...
        <header className="h-20 sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b border-outline flex items-center justify-between px-10 shrink-0">
