...
export function CoordinatorDashboardView() {
    ...
    return (
        <div className="min-h-screen pb-10">
            ...
            <div id="DashboardContent" className="space-y-8 px-4 sm:px-0">
                {/* Estadísticas de Cabecera */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {stats.map((s, i) => (
                        <div key={i} className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow">
                            <div className="flex items-center gap-4">
                                <div className={`w-12 h-12 ${s.bg} ${s.color} rounded-2xl flex items-center justify-center shrink-0 shadow-sm border border-slate-50`}>
                                    <s.icon size={24} />
                                </div>
                                <div>
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div>
                        <h2 className="text-2xl font-bold text-slate-800">Control de Estudiantes</h2>
                        <p className="text-slate-500 text-sm">Supervise el progreso académico y administrativo de su cohorte.</p>
                    </div>
